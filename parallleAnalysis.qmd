...
The methods start to deviate when correlations between factors get strong. Assume a stronger correlation of 0.7 between the two factors. The correlation between X and Y now is $0.5\times0.7=0.35$. The correlation matrix is
